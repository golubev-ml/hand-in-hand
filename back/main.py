...
from routers import auth_router, contacts, donations, logs, orders, payments, pictures
...
app.include_router(payments.router)   # HIH-9: /payment/return и /payment/fail
