...
def upgrade() -> None:
    ...
    op.add_column("pictures", sa.Column("is_new", sa.Boolean(), nullable=False, server_default=sa.text("false")))
    op.add_column("pictures", sa.Column("is_featured", sa.Boolean(), nullable=False, server_default=sa.text("false")))
